    ...
    return (
        <main className="min-h-screen bg-sky-50 p-4 sm:p-8 flex items-center justify-center font-sans">
            <div className="max-w-6xl w-full flex flex-col gap-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(180px,auto)]">
                    ...
                    <Link href="/dashboard" className="bg-rose-100 hover:bg-rose-200 transition-all duration-300 rounded-3xl p-6 flex flex-col justify-between group cursor-pointer shadow-sm hover:shadow-md md:col-span-2 md:col-start-2">
                        <div className="flex items-center justify-between">
                            <div>
                                <h3 className="text-xl font-bold text-rose-900 mb-1">Organization Login</h3>
                                <p className="text-rose-800/70 text-sm">Get Certify for your organization!</p>
                            </div>
                ...
                <Link href="https://linkedin.com/in/introvertcoder" className="bg-purple-200 rounded-3xl py-6 flex flex-col justify-center items-center group cursor-cat shadow-sm hover:shadow-md w-full">
                    <h3 className="text-sm font-bold text-violet-900">MADE WITH ❤️ BY HASAN</h3>
                </Link>
